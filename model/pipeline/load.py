...
from model.pipeline.data import MangroveDataset, MangroveDataModule
from model.pipeline import models
from model.pipeline import modules
...
def load_litmodule_from_config(path_config: str) -> LightningModule:
    ...
    litmodule_class = getattr(modules, litmodule_options.get("litmodule_class", "LitModule"))
